...
#include <memory>
#include "../../../../RTKLIB-rtklib_2.4.3-master/app/rtknavi_qt/markdlg.h"
...
QT_MOC_LITERAL(5, 58, 14) // "BtnRepDlgClick"
    ...
    "ChkMarkerNameClick\0BtnRepDlgClick"
};
...
void QMarkDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QMarkDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject QMarkDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_QMarkDialog.data,
    qt_meta_data_QMarkDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
